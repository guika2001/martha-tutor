  ...
  function getValidatorPack(langCode = "de") {
    if (langCode === "hu") {
      return {
        ...
        readability: 'HU módban ellenőrizd azt is, hogy a német szakkifejezések első előforduláskor kapnak-e magyar magyarázatot, és hogy a szokatlan jelölésekhez van-e rövid "Jelölések" blokk, ha szükséges.',
    ...
    if (langCode === "en") {
      return {
        ...
        readability: "Also check whether foreign technical terms are glossed and whether unusual notation is briefly explained when needed.",
    ...
    if (langCode === "es") {
      return {
        ...
        readability: "Comprueba también si los términos técnicos extranjeros se aclaran y si la notación poco habitual se explica brevemente cuando hace falta.",
    ...
    return {
      ...
      readability: "Pruefe auch, ob ungewoehnliche Fachbegriffe oder Notationen bei Bedarf kurz erklaert werden.",
